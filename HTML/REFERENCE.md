...
<h2>Input Tag <code>&lt;input&gt;</code>:</h2>
<ul>
<li>The <code>&lt;input&gt;</code> tag specifies an input field where the user can enter data.</li>
...
<li> <h4>For additional info check this <a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input/button" target="_blank">link</a></h4></li>
</ul>

...
const initialState = {
    default: 'https://images.unsplash.com/photo-1764087957302-ef0756ed8e0a?q=80&w=764&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    activeImg: null,
    edits: {
        brightness: 100,
        contrast: 100,
            ...
            <div className='panel'>
                ...
                <div className='controls'>
                    ...
                    <div className='buttons'>
                        <button onClick={() => dispatch({ type: 'ROTATE' })}>
                            Rotate
                        </button>
